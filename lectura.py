...
'''Llegeix una trama crea un json'''
def lectura():

    '''interpreta trama i retorna json'''
    def processa(trama):
    ...
    '''llegeix bytes fins que trobis una trama sencera'''
    while True:
        c=ser.read() #read 1 byte
        if(c!="I"): 
            continue #si no és inici de trama torna a llegir
        ...
        #intentar processar una trama fins que funcioni
        try:
            dades=processa(trama); #format json
            break 
        except: 
            pass
